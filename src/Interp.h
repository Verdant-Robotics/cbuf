...
public:
    ...
    void ErrorWithLoc(const ast_element* elem, const char *msg, ...);
    void ErrorWithLoc(const ast_struct* st, const char *msg, ...);
    void ErrorWithLoc(const ast_enum* en, const char *msg, ...);
