...
#
# NAME: Name for the cbuf library to include elsewhere, otherwise it is the name of the fist message
# OUTPUT_DIR : where to write the cbuf header INCLUDE_DIRS : List of paths where to search for includes
...
macro(build_cbuf)
  ...
  foreach(msg_file ${CBUF_MSG_FILES})
    ...
    add_custom_command(
      OUTPUT ${outdir}/${name}.h COMMAND mkdir -p ${outdir}
      COMMAND cbuf ${CMAKE_CURRENT_SOURCE_DIR}/${msg_file} ${incs} > ${outdir}/${name}.h
      DEPENDS cbuf ${CMAKE_CURRENT_SOURCE_DIR}/${msg_file} WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR})

    add_custom_command(
      OUTPUT ${outdir}/${name}_json.h COMMAND mkdir -p ${outdir}
